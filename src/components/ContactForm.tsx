    ...
    <form onSubmit={onSubmit} className="mt-10 max-w-xl space-y-7">
      <div className="grid gap-7 sm:grid-cols-2">
        <label className="block">
          ...
          <input
            ...
            className="mt-2 w-full border-b border-foreground/12 bg-transparent py-3 text-base outline-none transition-colors placeholder:text-muted/45 focus:border-[#7C5CF6]"
      ...
      <label className="block">
        ...
        <textarea
          ...
          className="mt-2 w-full resize-y border-b border-foreground/12 bg-transparent py-3 text-base outline-none transition-colors placeholder:text-muted/45 focus:border-[#7C5CF6]"
